...
<html>
	<head>
		...
		<title>Usuwanie pogrzebu - Panel pracownika</title>
	</head>
	<body>
		...
		<section class="pageContent">
			<h2>Usuwanie pogrzebu</h2>
			<p>Czy NA PEWNO chcesz usunąć ten pogrzeb? Ta operacja jest nieodwracalna!</p>
			<form method="POST" action="deleteFuneral.html" style="display: inline;">
				<input type="text" name="id" value="${id}" hidden />
				<input type="text" name="accept" value="1" hidden />
				<input type="submit" value="Tak" />
			</form>
			<form method="POST" action="funerals.html" style="display: inline;">
