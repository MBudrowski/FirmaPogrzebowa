...
<html>
	<head>
		...
		<title>Zablokowany zasób - Panel pracownika</title>
	</head>
	<body>
		...
		<section class="pageContent">
			<h2>Zasób jest zablokowany</h2>
			<p>Zasób jest aktualnie edytowany przez innego użytkownika. Spróbuj ponownie później.</p>
		</section>
