...
<html>
	<head>
		...
		<title>Wieńce - Panel pracownika</title>
	</head>
	<body>
        ...
        <section class="pageContent">
			...
			<table class="products">
				<tbody>
					<c:forEach items="${wience}" var="z">
						<tr>
							<td class="wreathImg"><a href="../${z.sciezkaObrazka}"><img src="../${z.sciezkaObrazka}" class="wreathImg" /></a></td>
							<td class="productInfo">
								<p><b>Nazwa:</b> ${z.nazwa}</p>
								<p><b>Opis:</b> ${z.opis}</p>
								<p><b>Kwiaty żywe:</b> ${z.wieniec.czyKwiatyZywe()}</p>
