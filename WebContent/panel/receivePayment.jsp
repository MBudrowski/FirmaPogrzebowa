...
<html>
	<head>
		...
		<title>Przyjęcie zapłaty za pogrzeb - Panel pracownika</title>
	</head>
	<body>
		...
		<section class="pageContent">
			<h2>Opłacenie pogrzebu</h2>
			<p>Przyjmij poniższą kwotę zapłaty za pogrzeb, a następnie zatwierdź operację.</p>
			<p>Klient: ${pogrzeb.klient.imie} ${pogrzeb.klient.nazwisko}</p>
			<p>Kwota do zapłaty: ${pogrzeb.cenaString}</p>
