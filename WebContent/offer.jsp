...
<html>
	<head>
		...
		<title>Oferta - Firma pogrzebowa</title>
	</head>
	<body>
		...
		<section class="pageContent">
			...
			<ul>
				<li>organizacja pogrzebów,</li>
				<li>sprzedaż <a href="coffins.html">trumien</a>, <a href="wreaths.html">wieńców</a>, <a href="candles.html">zniczy</a>.</li>
			</ul>
		</section>
